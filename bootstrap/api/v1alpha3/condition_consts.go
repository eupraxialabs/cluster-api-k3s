...
// Conditions and condition Reasons for the KZerosConfig object
...
const (
	...
	// the KZerosConfig controller ensure this pre-condition is satisfied.
	...
	// DataSecretGenerationFailedReason (Severity=Warning) documents a KZerosConfig controller detecting
...
const (
	...
	//
	// NOTE: Cluster certificates are generated only for the KZerosConfig object linked to the initial control plane
	...
	// CertificatesGenerationFailedReason (Severity=Warning) documents a KZerosConfig controller detecting
	...
	// CertificatesCorruptedReason (Severity=Error) documents a KZerosConfig controller detecting
